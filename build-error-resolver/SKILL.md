...
This is a compatibility skill restored so historical prompts, docs, and integrations that invoke `build-error-resolver` still resolve in the current runtime.
